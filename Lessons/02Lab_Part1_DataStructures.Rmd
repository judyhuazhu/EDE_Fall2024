...
# Create a vector contain vector 1 and vector 4
c(vector1, vector4)
...
matrix1[4, 1] # value in matrix 1, row4, column1

matrix1[4,  ] # row 4 in matrix 1

matrix1[ , 3] # column 3 in matrix 1
