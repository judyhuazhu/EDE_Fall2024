...
NTL.phys.data.TuesLake <- filter(NTL.phys.data, lakename == "Tuesday Lake",year4 >= 1990 & year4 <=1999)
NTL.phys.data.TuesLake19c <- filter(NTL.phys.data.TuesLake, year4 >= 1990 & year4 <=1999)
NTL.phys.data.TuesLake19c
NTL.phys.data.TuesLake
...
# (hint: you will need to filter for depth==0). 
  ...
  NTL.phys.data.TuesLake.July.T_mean <-
    NTL.phys.data.TuesLake.July%>% 
